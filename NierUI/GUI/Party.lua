-- app.Net_Party:get_field("_InvitedQuestList"):get_User()
-- app.Net_Party.InvitedQuestInfo
...
d2d.register(
    ...
    function()
        ...
        local cPlayerManageControl  = Managers.Player:get_field("_InstancedPlayerList")
