...
d2d.register(
    ...
    function()
        ...
        if not Net_SocialUserInfo then -- LOBBY
            Net_SocialUserInfo = Managers.Network:get_UserInfoManager():getSelfUserInfo(1, 0)
        end
        if not Net_SocialUserInfo then -- QUEST
            Net_SocialUserInfo = Managers.Network:get_UserInfoManager():getSelfUserInfo(2, 0)
        end
        if not Net_SocialUserInfo then -- LINK
            Net_SocialUserInfo = Managers.Network:get_UserInfoManager():getSelfUserInfo(3, 0)
        end
        if not Net_SocialUserInfo then -- MEMORIES
            Net_SocialUserInfo = Managers.Network:get_UserInfoManager():getSelfUserInfo(4, 0)
        end
