...
Color.Blue      = 0xFF589494    -- ONLY KIREAJI RATE IS RECOMMENDED
Color.Green     = 0xFF4DCD4D    -- ONLY KIREAJI RATE IS RECOMMENDED
Color.Yellow    = 0xFFCD954D    -- ONLY KIREAJI RATE IS RECOMMENDED
Color.Orange    = 0xFFCD664D
Color.dOrange   = 0xAACD664D
Color.Red       = 0xFFAD3E3E
Color.dRed      = 0xAAAD3E3E
Color.Byte     = {             -- TEMPORARY ALPHA DIM ANIMATION FIX (...)
    c77 = 119,
    cAA = 170,
    cFF = 255
}      
